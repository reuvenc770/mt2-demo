...
<center>
		<form method=post name="campform" action=appendEID_upd.cgi target=_top>
...
print<<"end_of_html";
		...
		<tr><td>Append Client/Username: <input type=checkbox name=appendClient value="Y"></td></tr>
<tr><td colspan=2 align=middle><input type=submit value="Add"></td></tr>
		<tr>
<td align="center" valign="top"><br>
                <a href="appendEID_list.cgi" target=_top>
