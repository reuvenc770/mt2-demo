...
# camp_edit.cgi
#
# this page is for review and editing of a campaign
#
# History
...
$sql = "select campaign_name,template_id,subject,status,created_datetime
	from campaign where campaign_id = $campaign_id";
$sth = $dbhq->prepare($sql);
$sth->execute();
($campaign_name,$template_id,$subject,$status,$created_datetime) = $sth->fetchrow_array();
$sth->finish();
...
<TD vAlign=top align=left bgColor=#999999>
    ...
    <TD vAlign=top align=left bgColor=#ffffff>
        ...
        <TD vAlign=center align=left><FONT face="verdana,arial,helvetica,sans serif" color=#509C10 
            size=3><B>Review and Edit Campaign Settings</B> 
            </FONT></TD>
		</TR>
        <TR>
    	...
    	<TD><FONT face="verdana,arial,helvetica,sans serif" color=#509C10 
    		size=2>These are the current settings for this Campaign.  You can edit the 
			individual settings, one at a time, using the links or edit all settings using the 
    		<B>Wizard</B>.<BR></FONT></TD>
		</TR>
		<TR>
...
if ($status ne "C")
{
	print qq { <a href="camp_edit_lists.cgi?campaign_id=$campaign_id">Change List(s)</a> \n};
}
print << "end_of_html";
                    </TD>
					</TR>
                    ...
                    <TD vAlign=center noWrap align=right><FONT 
                        face="verdana,arial,helvetica,sans serif" 
                        color=#509C10 size=2>What:&nbsp;&nbsp;&nbsp; 
                        </FONT></TD>
                    <TD vAlign=center align=left><FONT 
                        face="verdana,arial,helvetica,sans serif" 
                        color=#509C10 size=2>$template_name</FONT> </TD>
					</TR>
                    <TR> <TD><IMG height=7 src="$images/spacer.gif"></TD></TR>
                    <TR>
                    <TD vAlign=center noWrap align=right><FONT 
		...
		<TD>
			...
			<td width="25%" align="center">
				...
				<img src="$images/copy_emailing.gif" border=0></a></td>
			<td width="25%" align="center">
				<a href="camp_preview.cgi?campaign_id=$campaign_id&format=H" target="_new">
				<img src="$images/preview_rev.gif" border=0></a></td>
			<td width="25%" align="center">
				<a href="camp_advanced.cgi?campaign_id=$campaign_id">
				<img src="$images/adveditor.gif" border=0></a></td>
			<td width="25%" align="center">
