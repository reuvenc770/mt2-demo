...
function exportfile()
{
    var newwin = window.open("/cgi-bin/trigger_client_export.cgi", "Export", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=900,height=500,left=25,top=50");
    newwin.focus();
}
</script>
...
print<<"end_of_html";
		...
		<tr><td align="center"><a href="#" onClick="javascript:exportfile();">Export</a></TD></tr>
