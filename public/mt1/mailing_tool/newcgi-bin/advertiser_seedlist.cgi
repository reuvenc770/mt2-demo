...
util::header("Advertiser SeedList");
print << "end_of_html";
</TD>
</TR>
<TR>
<TD vAlign=top align=left bgColor=#FFFFFF>
	...
	<TD vAlign=top align=left bgColor=#ffffff colSpan=10>
		...
		<TD vAlign=center align=left><FONT face="verdana,arial,helvetica,sans serif" 
			color=#509C10 size=3> <B> Advertiser Seedlist</B> </FONT></TD>
		</TR>
		<TR>
		...
		<TD>
			...
			<TD align=middle>
				...
				<FORM action="save_advertiser_seedlist.cgi" method="post">
...
end_of_html
$sql = "select email_addr from advertiser_seedlist where advertiser_id=$aid order by email_addr";
...
print <<"end_of_html";
		...
		<TD>
			...
			<TD width=100% align=center>
				...
				<IMG src="$images/home_blkline.gif" border="0"></A>&nbsp;&nbsp;<a href="/cgi-bin/advertiser_disp2.cgi?puserid=$aid"><img src="/images/cancel_blkline.gif" border=0></a></td>
			</TR>
			</TBODY>
			</TABLE>
