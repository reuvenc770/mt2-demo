...
util::header("Find a Chunk User Record By Id");
...
<TD vAlign=top align=left bgColor=#FFFFFF>
    ...
    <TD vAlign=top align=left bgColor=#ffffff colSpan=10>
        ...
        <TD vAlign=center align=left><FONT face="verdana,arial,helvetica,sans serif" color=#509C10 
            size=3><B>Find Chunk User Information By Id</B> </FONT></TD>
		</TR>
        <TR>
...
print << "end_of_html" ;
        ...
        <TD>
            ...
            <TD align=middle>
                ...
                <TD align=middle>
        		<FORM name=add_list action="show_chunk_info_id.cgi" method=post onsubmit="return ProcessForm('A');">
                    <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    <TBODY>
                    <TR>
                    <TD align=middle><IMG height=3 src="$images/spacer.gif" width=3></TD>
