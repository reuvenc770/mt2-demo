...
# dd_copy.cgi
#
# this page copies a Daily Deal setting 
#
# History
# *****************************************************************************************
...
$sql="select name,settingType from DailyDealSetting where dd_id=?";
$sth=$dbhq->prepare($sql);
$sth->execute($dd_id);
($mname,$ctype)=$sth->fetchrow_array();
$sth->finish();
#
...
<title>$ctype Deal Setting Copy </title>
</head>
...
<html><head><title>Copy $ctype Deal Settings</title>
...
<body>
<div id="container">
  <h1>Edit Daily Deal Settings</h1>
  ...
  <div id="form">
	<form method="get" name="campform" action="dd_copy_save.cgi">
