...
#
$sql = "select templateName,templateCode from mailingHeaderTemplate where $userDataRestrictionWhereClause templateID=$nl_id"; 
...
<title>CUSTOM MAIL HEADER TEMPLATE SETUP</title>
</head>
