...
# *****************************************************************************************
# ironcladgroup_list.cgi
#
# this page displays the list of IronClad Groups and lets the user edit / add
#
# History
# *****************************************************************************************
...
function Remove(gid)
{
	...
	<TD vAlign=top align=left bgColor=#ffffff colSpan=10>
		...
		<TBODY>
		<tr>
		<td><form method=POST action=ironcladgroup_add.cgi>IronClad Group Name: <input type=text name=gname size=25 maxlength=25>&nbsp;&nbsp;&nbsp;&nbsp;<input type=submit value="Add Group"></form>
		</td>
		</tr>
		<tr>
<td align="center" valign="top">
		...
		<TD><FONT face="verdana,arial,helvetica,sans serif" color=#509C10 size=2>
			Select a Group to edit or add a new Group</FONT></TD>
		</TR>
		<TR>
...
while (($gid,$gname) = $sth->fetchrow_array())
{
	...
	print qq { <TR bgColor=$bgcolor><TD align=left><font color="#509C10" face="verdana,arial,helvetica,sans serif" size="2"><A HREF="ironcladgroup_edit.cgi?gid=$gid">$gname</a></font></TD><TD><input type=button value="Delete" onClick="return Remove($gid);"></td></TR> \n };
}
