#!/usr/bin/perl
#===============================================================================
# File   : save_company_approval.cgi 
#
# History
# Jim Sobeck, 05/17/06 
#===============================================================================
...
# get some directories from sysparm
	...
	$sql = "delete from company_approval where company_id=$company_id";
	$rows = $dbhu->do($sql);
...
$log_file = "/tmp/approval_${user_id}.error.log";
	...
	print << "end_of_html" ;
		...
		<td colspan=4 align="center" width="100%">
			...
			<td width="50%" align="center">
				<a href="/cgi-bin/company_disp.cgi?company_id=$company_id">
...
sub add_upd_email_user
{
	...
	$sql = "insert into company_approval(company_id,email_addr) values($company_id,'$email_addr')";
	$rows = $dbhu->do($sql);
   	if ($dbhu->err() != 0)
   	{
       	$errmsg = $dbhu->errstr();
       	util::logerror("Updating company_approval record: $sql: $errmsg");
       	exit(0);
   	}
