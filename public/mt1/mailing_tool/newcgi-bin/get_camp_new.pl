...
my $bin_dir_http;
	...
	open (MAIL,">/var/www/html/templates/camp_${camp_id}.txt");
   	print MAIL "From: {{FROMADDR}}\n";
   	print MAIL "To: {{EMAIL_ADDR}}\n";
   	print MAIL "Reply-To: {{FOOTER_DOMAIN}}{{CID}}\@{{DOMAIN}}\n";
   	print MAIL "Subject: {{SUBJECT}}\n";
	print MAIL "Date: {{MAILDATE}}\n";
	print MAIL "Message-ID: <{{MSGID}}>\n";
	print MAIL "X-Destination-ID: {{EMAIL_ADDR}}:{{CID}}:\n";
...
##  new honeybot hidden link - jp Fri Mar 31 14:48:52 EST 2006  ##
	$template_text =~ s\<body>\<body><!-- <a href="http://{{FOOTER_SUBDOMAIN}}.{{DOMAIN}}/cgi-bin/redir1.cgi?eid={{EMAIL_USER_ID}}&amp;cid={{CID}}&amp;em={{EMAIL_ADDR}}&amp;id=23482&amp;nid={{NID}}">&nbsp;-&nbsp;</a> //--><center><p STYLE="font-size: 10pt; font-family:arial">{{HEADER_TEXT}}</p><p>${tracking_str}\;
##
...
($BASE_DIR) = $sth1->fetchrow_array();
$sth1->finish;
## - Removed by JES - 05/25 - Not needed
