...
sub disp_body
{
	...
	print << "end_of_html" ;
	<center><a href="/cgi-bin/header_content.cgi?type=add"><img src="/mail-images/add.gif" border=0></a><br><br>
	...
	<TR bgColor="#509C10" height=15>
		...
		(click name to edit the header)</b></font></TD>
	</TR>
	<TR> 
...
end_of_html
	...
	my $sql=qq|SELECT id,header_name,date_add,inactive_date,header_content,modified_date FROM header_content|;
	...
	while (my $hr=$sth->fetchrow_hashref) {
		...
		print qq{		<A HREF="header_content.cgi?type=show&headID=$hr->{id}">$hr->{header_name}</a></font></TD> \n } ;
        ...
        print qq^
			<TD align=left><font color="#509C10" face="Arial" size="2"><a href="/cgi-bin/header_content.cgi?type=del&headID=$hr->{id}">Delete</a>&nbsp;&nbsp;<a href="/cgi-bin/header_content.cgi?type=preview&headID=$hr->{id}" target=_blank>Preview</a></TD> \n ^;
		print qq{</TR> \n} ;
