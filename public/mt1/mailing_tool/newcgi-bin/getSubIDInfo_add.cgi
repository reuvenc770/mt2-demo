...
<center>
		<form method=post name="campform" action=getSubIDInfo_upd.cgi target=_top>
...
print<<"end_of_html";
		...
		<tr><td>Chunk Size: <input type=text name=chunkSize value="0" size=10 maxlength=10></td></tr>
<tr><td colspan=2 align=middle><input type=submit value="Add"></td></tr>
		<tr>
<td align="center" valign="top"><br>
                <a href="getSubIDInfo_list.cgi" target=_top>
