...
sub disp_body
{
	...
	print << "end_of_html" ;
	<center><a href="/cgi-bin/style_content.cgi?type=add"><img src="/mail-images/add.gif" border=0></a><br><br>
...
end_of_html
	...
	my $sql=qq|SELECT id,style_name,date_add,inactive_date,style_content FROM style_content|;
	...
	while (my $hr=$sth->fetchrow_hashref) {
		...
		print qq{		<A HREF="style_content.cgi?type=show&styleID=$hr->{id}">$hr->{style_name}</a></font></TD> \n } ;
        ...
        print qq^
			<TD align=left><font color="#509C10" face="Arial" size="2"><a href="/cgi-bin/style_content.cgi?type=del&styleID=$hr->{id}">Delete</a>&nbsp;&nbsp;<a href="/cgi-bin/style_content.cgi?type=preview&styleID=$hr->{id}" target=_blank>Preview</a></TD> \n ^;
		print qq{</TR> \n} ;
