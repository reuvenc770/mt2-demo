...
# mta_setup_top.cgi
#
# this page display top frame for setting up a mta
#
# History
...
<div id="container">
  ...
  <div id="form">
	<form method="post" name="campform" action="mta_isp_setup.cgi" target="bottom">
	<input type=hidden name="mta_id" value="$mta_id"> 
	  <table>

		  <tr>
			<td class="label">MTA Settings Name:</td>
			<td class="field">
...
end_of_html
$sql="select class_id,class_name from email_class where status='Active' and class_id=3";
$sth=$dbhq->prepare($sql);
$sth->execute();
