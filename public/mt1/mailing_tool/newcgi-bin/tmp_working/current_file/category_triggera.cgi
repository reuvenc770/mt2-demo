...
print<<"end_of_html";
	...
	parent.frames[1].location = "/newcgi-bin/chk_category_trigger.cgi?cid=$cid&trigger1="+selObj.options[selIndex].value+"&trigger2="+selObj1.options[selIndex1].value+"&alt_trigger="+selObj2.options[selIndex2].value;
end_of_html
}
else
{
...
if ($alt_trigger > 0)
{
	$sql = "select advertiser_id,advertiser_name from advertiser_info where category_id in (select category_id from advertiser_info,creative where creative_id=$alt_trigger and creative.advertiser_id=advertiser_info.advertiser_id) and status='A' order by advertiser_name";
}
else
{
	$sql = "select advertiser_id,advertiser_name from advertiser_info where status='A' order by advertiser_name"; 
										...
										<tr>
											...
											<table cellSpacing="0" cellPadding="0" width="100%" border="0" id="table12">
												<tr>
													...
													<img height="22" src="/images/save_rev.gif" width="81" border="0" onClick="ProcessForm()"> <a href="/cgi-bin/category_trigger_list.cgi?userid=$client_id" target=_top><img src="/images/cancel.gif" border=0></a>
													</td>
												</tr>
											</table>
											</td>
