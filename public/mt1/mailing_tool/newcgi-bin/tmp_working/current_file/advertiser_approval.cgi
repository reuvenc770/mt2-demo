...
util::header("Advertiser Approval List");
print << "end_of_html";
</TD>
</TR>
<TR>
<TD vAlign=top align=left bgColor=#FFFFFF>
	...
	<TD vAlign=top align=left bgColor=#ffffff colSpan=10>
		...
		<TD vAlign=center align=left><FONT face="verdana,arial,helvetica,sans serif" 
			color=#509C10 size=3> <B> Advertiser Approval List</B> </FONT></TD>
		</TR>
		<TR>
		...
		<TD>
			...
			<TD align=middle>
				...
				<FORM action="save_advertiser_approval.cgi" method="post">
