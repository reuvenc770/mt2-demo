...
# Jim Sobeck, 05/22/02, Add logic for EDealsDirect
# *****************************************************************************************
...
my $the_email = &util_mail::mail_preview($dbh,$campaign_id,$format,$email_addr,$email_user_id,$user_id,$footer_color,$aid,$internal_flag,$unsub_url,$unsub_image,$content_id);
...
<TD vAlign=top align=left bgColor=#999999>
    ...
    <TD vAlign=top align=left bgColor=#ffffff colSpan=10>
        ...
        <TD align=left width=190>
            <INPUT type=text size=80 value="setup\@spirevision.com" name="cemail"></TD>
        ...
        <TD align=left width=190>
            <INPUT type=text size=50 value="setup\@spirevision.com" name="cemail"></TD>
        <TD align=center width=220>&nbsp;&nbsp;
