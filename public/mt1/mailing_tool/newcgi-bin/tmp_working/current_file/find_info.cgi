...
util::header("Find a User Record");
...
end_of_html
	...
	print qq{ To find information for an email address please enter the email \n } ;
	print qq{ address and select <B>Find</B>. \n } ;
print << "end_of_html" ;
			</FONT></TD>
		</TR>
		</TBODY>
        ...
        <TD>
            ...
            <TD align=middle>
                ...
                <TD align=middle>
        		<FORM name=add_list action="show_info.cgi" method=post onsubmit="return ProcessForm('A');">
                    <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    <TBODY>
                    <TR>
                    <TD align=middle><IMG height=3 src="$images/spacer.gif" width=3></TD>
