...
print << "end_of_html";
					...
					<TD vAlign=center align=left><FONT face="verdana,arial,helvetica,sans serif" color=#509C10 size=2>Send To:
						<input type=radio name=clast60 value="N" $no_flag>All&nbsp;&nbsp;<input type=radio name=clast60 value="7" $seven_flag>Last 7 Days&nbsp;&nbsp;&nbsp;<input type=radio name=clast60 value="M" $month_flag>Last 30 Days&nbsp;&nbsp;&nbsp;<input type=radio name=clast60 value="Y" $yes_flag>Last 60 Days&nbsp;&nbsp;&nbsp;<input type=radio name=clast60 value="9" $last90_flag>Last 90 Days</font></td>
					</tr>	
					<TR>
					<TD vAlign=center align=left><FONT face="verdana,arial,helvetica,sans serif" color=#509C10 size=2>Send To:
