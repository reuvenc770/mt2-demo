...
<tr><td><b>Brand:</b></td><td align=left><select name=brand_id></select>&nbsp;&nbsp;<input type=submit value="Go" name="action">&nbsp;&nbsp;<input type=submit value="Copy Selections" name="action"></td></tr>
		<TR>
