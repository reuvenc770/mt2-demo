...
end_of_html
$sql="select url,code,company,daily_deal from advertiser_tracking,user where advertiser_tracking.client_id=user.user_id and advertiser_id=$aid";
$sth = $dbh->prepare($sql);
$sth->execute();
...
<b>Code: (to tie it back to the network - stat purposes)</b><br>
											<input maxLength="255" size="50" name="tracking_code"><br>
<p>
