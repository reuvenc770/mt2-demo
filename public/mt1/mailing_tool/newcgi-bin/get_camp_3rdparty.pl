...
my $bin_dir_http;
	...
	open (MAIL,">/var/www/html/3rdparty_templates/camp_${camp_id}.txt");
	print MAIL "MIME-Version: 1.0\n";
	print MAIL "X-Accept-Language: en\n";
	print MAIL "X-Priority: Normal\n";
   	print MAIL "From: %%\$from%%\n";
   	print MAIL "To: %%\$email%%\n";
   	print MAIL "Subject: %%\$subject%%\n";
	print MAIL "Content-Type: multipart/alternative;\n";
	print MAIL "\tboundary=\"------------113631763198370\";\n";
	print MAIL "\tclass-id=4:%%rotx%\$email%%:%%\$msgid%%\n\n";
	print MAIL "--------------113631763198370\n";
	print MAIL "Content-Type: text/html; charset=\"ISO-8859-1\"\n";
	print MAIL "Content-Transfer-Encoding: 7bit\n";
	print MAIL "X-VMP-Type: html\n";
	$format = "H";
	...
	$the_email =~ s/{{TEXT_TYPE}}/Arial/g;
	$the_email =~ s/{{TEXT_SIZE}}/10/g;
	$the_email =~ s/{{TEXT_ALIGN}}/center/g;
...
#	$tracking_str = "<IMG SRC=\"http://{{DOMAIN}}/cgi-bin/open_email1.cgi?id={{EMAIL_USER_ID}}&amp;cid={{CID}}&amp;f={{FID}}&amp;s={{SID}}&amp;c={{CRID}}&amp;u={{URLID}}\" border=0 height=1 width=1>";
	$tracking_str = "<IMG SRC=\"http://{{DOMAIN}}/cgi-bin/open_email1.cgi?id={{EMAIL_USER_ID}}&amp;cid={{CID}}&amp;f={{FID}}&amp;s={{SID}}&amp;c={{CRID}}&amp;\" border=0 height=1 width=1>";
##	$template_text =~ s\<body>\<body><center><p STYLE="font-size:10pt; font-family:arial">{{HEADER_TEXT}}</p></center><p>${tracking_str}\;
##  new honeybot hidden link - jp Fri Mar 31 14:48:52 EST 2006  ##
    $template_text =~ s\<body>\<body><!-- <a href="http://{{FOOTER_SUBDOMAIN}}.{{DOMAIN}}/cgi-bin/redir1.cgi?eid={{EMAIL_USER_ID}}&amp;cid={{CID}}&amp;em={{EMAIL_ADDR}}&amp;id=23482&amp;nid={{NID}}">&nbsp;-&nbsp;</a> //--><p align={{TEXT_ALIGN}} STYLE="font-size: {{TEXT_SIZE}}pt; font-family:{{TEXT_TYPE}}>{{HEADER_TEXT}}</p><p>${tracking_str}\;
##
...
{{UNSUBSCRIBE}} 
		...
		$template_text .= "<p align={{TEXT_ALIGN}} STYLE=\"font-size:{{TEXT_SIZE}}pt; font-family:{{TEXT_TYPE}}\">{{FOOTER_TEXT}}</p></body></html>";
...
#system(@args) == 0 or die "system @args failed: $?";
        		...
        		if ( /\// )
        		{
                        	$temp_str = "<a href=\"http://{{FOOTER_SUBDOMAIN}}.{{DOMAIN}}/cgi-bin/redir1.cgi?eid={{EMAIL_USER_ID}}&amp;cid=0&amp;em={{EMAIL_ADDR}}&amp;id=$link_id\" target=\"_blank\"><img src=\"http://www.{{IMG_DOMAIN}}/images/$unsub_img\" border=0></a><br><br>";
				}
				else
				{
                        	$temp_str = "<a href=\"http://{{FOOTER_SUBDOMAIN}}.{{DOMAIN}}/cgi-bin/redir1.cgi?eid={{EMAIL_USER_ID}}&amp;cid=0&amp;em={{EMAIL_ADDR}}&amp;id=$link_id\" target=\"_blank\"><img src=\"http://www.{{IMG_DOMAIN}}/images/unsub/$unsub_img\" border=0></a><br><br>";
				}
                    	}
					}
			if ($footer_color eq "WHITE")
			{
                $template_text =~ s\{{UNSUBSCRIBE}}\$temp_str<a href="http://{{FOOTER_SUBDOMAIN}}.{{DOMAIN}}/cgi-bin/redir1.cgi?eid={{EMAIL_USER_ID}}&amp;cid={{CID}}&amp;em={{EMAIL_ADDR}}&amp;id=42&amp;nid={{NID}}" target=_blank><img src="http://www.{{IMG_DOMAIN}}/fimg/{{FOOTER_STR}}_1.jpg" border=0></a><br><a href="http://{{FOOTER_SUBDOMAIN}}.{{DOMAIN}}/cgi-bin/redir1.cgi?cid=0&amp;eid={{EMAIL_USER_ID}}&amp;id=51&amp;nid={{NID}}" target=_blank><img src="http://www.{{IMG_DOMAIN}}/fimg/{{FOOTER_STR}}_2.jpg" border=0></a>\g;
			}
			else
			{
                $template_text =~ s\{{UNSUBSCRIBE}}\$temp_str<a href="http://{{FOOTER_SUBDOMAIN}}.{{DOMAIN}}/cgi-bin/redir1.cgi?eid={{EMAIL_USER_ID}}&amp;cid={{CID}}&amp;em={{EMAIL_ADDR}}&amp;id=42&amp;nid={{NID}}" target=_blank><img src="http://www.{{IMG_DOMAIN}}/fimg/{{FOOTER_STR}}_1.jpg" border=0></a><br><a href="http://{{FOOTER_SUBDOMAIN}}.{{DOMAIN}}/cgi-bin/redir1.cgi?cid=0&amp;eid={{EMAIL_USER_ID}}&amp;id=51&amp;nid={{NID}}" target=_blank><img src="http://www.{{IMG_DOMAIN}}/fimg/{{FOOTER_STR}}_2.jpg" border=0></a>\g;
