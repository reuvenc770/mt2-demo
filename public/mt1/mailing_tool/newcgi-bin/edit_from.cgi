...
###$dbh = $util->get_dbh;
#
$sql = "select advertiser_from,approved_flag,original_flag,date_format(inactive_date,'%m/%d/%y'),copywriter,copywriter_name from advertiser_from where advertiser_id=$aid and from_id=$sid"; 
$sth = $dbhq->prepare($sql);
$sth->execute();
($from,$aflag,$oflag,$idate,$copywriter,$copyname) = $sth->fetchrow_array();
$sth->finish();
...
<body>
<form action="/cgi-bin/upd_from.cgi" method="post" accept-charset="UTF-8">
<p><b>From: </b><input type=text value="$from" name=cfrom maxlength=80 size=50>&nbsp;&nbsp;<b>Inactive Date(MM/DD/YY):</b><input type=text value="$idate" name=idate maxlength=10 size=11><br>
<input type=hidden name=aid value="$aid">
<input type=hidden name=sid value="$sid">
<p>
<b>Approved</b> <input type="checkbox" $aflag_str name="aflag" size="40" maxlength="90" value="Y"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Original</b> <input type="checkbox" $oflag_str name="oflag" size="40" maxlength="90" value="Y"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Copywriter</b> <input type="checkbox" $copywriter_str name="copywriter" size="40" maxlength="90" value="Y"></b>&nbsp;&nbsp;&nbsp;<b>Copywriter Name:</b><select name=copywriter_name>
end_of_html
