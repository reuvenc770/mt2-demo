#!/usr/bin/perl
#===============================================================================
# Purpose: Suppression List Delete 
# File   : supplist_delete.cgi
#
#--Change Control---------------------------------------------------------------
...
<title>Delete a suppression list</title>
...
<font class="txtB"><a href="http://209.120.224.2:83/newcgi-bin/mainmenu.cgi">go home &raquo;</a></font> 
    </td>
  </tr>
</table>

<form method=post action="supplist_delete_save.cgi">
...
<tr>
	...
	<p class="title"><b>Delete suppression list:</b><br>$list_name</p>
	<p>Are you sure you want to delete this suppression list?</p>
	<p> <input type="submit" value="delete" class="txtS" name="btn"> <input type="submit" value="cancel" class="txtS" name="btn"></p></td>
</tr>
</table>
</form>
