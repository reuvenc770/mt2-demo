#!/usr/bin/perl
#===============================================================================
# File   : save_company_seedlist.cgi
#
#
# History
# Jim Sobeck, 05-17-2006 
#===============================================================================
...
# get some directories from sysparm
	...
	$sql = "delete from company_seedlist where company_id=$company_id";
	$rows = $dbhu->do($sql);
...
sub add_upd_email_user
{
	...
	$sql = "insert into company_seedlist(company_id,email_addr) values($company_id,'$email_addr')";
	$rows = $dbhu->do($sql);
   	if ($dbhu->err() != 0)
   	{
       	$errmsg = $dbhu->errstr();
       	util::logerror("Updating company_seedlist record: $sql: $errmsg");
       	exit(0);
   	}
