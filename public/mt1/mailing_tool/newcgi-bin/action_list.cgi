#!/usr/bin/perl
#===============================================================================
# Purpose: Displays a List of ActionString 
# File   : action_list.cgi
#
#===============================================================================
...
sub disp_body
{
	...
	print << "end_of_html" ;
	<center><form method=post action="/cgi-bin/action_add.cgi">Action String: <input type=text name="action_string" size=80 maxlength=255>&nbsp;&nbsp;<input type=image src="/mail-images/add.gif" border=0></form><br><br>
	<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
	<TBODY>
	<TR bgColor="#509C10" height=15>
		<TD colspan="5" align=center height=15>
		<font face="Verdana,Arial,Helvetica,sans-serif" color="white" size="3">
		<b>List of Current Action Strings</font>
		<font face="Verdana,Arial,Helvetica,sans-serif" color="white" size="2">
		(click name to edit the action)</b></font></TD>
	</TR>
	<TR> 
...
end_of_html
	...
	#===========================================================================
	# Loop - Get ActionString 
	#===========================================================================

	$sql = "select action_id,action_string from ActionString order by action_string"; 
	...
	while (($sid,$name) = $sth->fetchrow_array())
	{
		...
		print qq{		<A HREF="action_edit.cgi?sid=$sid">$name</a></font></TD> \n } ;
        print qq{	<TD align=left><font color="#509C10" face="Arial" size="2"><a href="/cgi-bin/action_del.cgi?sid=$sid">Delete</a></font>&nbsp;\n } ;
		print qq{</TR> \n} ;
