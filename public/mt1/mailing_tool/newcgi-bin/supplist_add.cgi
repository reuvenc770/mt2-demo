...
util::header("Add a New Suppression List");
...
end_of_html
	...
	print qq{ To ADD suppression list please enter the name \n } ;
...
print <<"end_of_html";
        ...
        <FORM name=add_list action="supplist_upd.cgi" method=get onsubmit="return ProcessForm('A');">
        ...
        <TD>
            ...
            <TD align=middle>
                ...
                <TD align=middle>
                    ...
                    <TD vAlign=center align=left>
						<FONT face="verdana,arial,helvetica,sans serif" color=#509C10 size=2>
						<select name=stype><option value="Normal">Normal</option><option value="Group">Group</option></select>
						</FONT></TD>
					</TR>
                    <TR>
                    <TD align=middle><IMG height=3 src="$images/spacer.gif" width=3></TD>
