...
sub disp_body
{
	...
	<TR bgColor="#509C10" height=15>
		...
		<b>List of Footers</font>
		<font face="Verdana,Arial,Helvetica,sans-serif" color="white" size="2">
		(click footer to edit the footer)</b></font></TD>
	</TR>
	<TR> 
	<TD bgcolor="#EBFAD1" align="center" width="05%">
...
end_of_html
	...
	#===========================================================================
	$sql = "select footer_id,footer_name,dateAdded from Footers where $userDataRestrictionWhereClause status='A' order by footer_id";
