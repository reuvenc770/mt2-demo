...
#
$sql = "select footer_name,footer_code from Footers where $userDataRestrictionWhereClause footer_id=$nl_id"; 
	...
	<tr>
		...
		<input type=hidden name=backto value="">
			...
			<table id="table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td bgColor="#ffffff"><b>CUSTOM MAIL FOOTER TEMPLATE SETUP</b></td>
				</tr>
			</table>
			<p><b>Footer name:</b>&nbsp;&nbsp;<input type=text size=30 maxlength=50 name=template_name value="$template_name"> 
			<br/>
