...
print<<"end_of_html";
		...
		<tr>
			<td><b><font face="Verdana" size="2">Default Client:</font></b></td>
			<td width="320"><font size="1"><select name="default_client">
end_of_html
...
{
	if ($uid == $default_client)
	{
		print "<option value=$uid selected>$company</option>\n";
	}
	else
	{
...
print<<"end_of_html";
		...
		<tr>
			...
			<td width="320">
											<input maxLength="50" size="36" name="rname" value="$rname"></td>
		</tr>
		<tr>
			<td><b><font face="Verdana" size="2">Replace {{LOC}} with:</font></b></td>
			<td width="320">
											<input maxLength="50" size="36" name="rloc" value="$rloc"></td>
		</tr>
		<tr>
			<td><b><font face="Verdana" size="2">Replace {{DATE}} with:</font></b></td>
			<td width="320">
											<input maxLength="50" size="36" name="rdate" value="$rdate"></td>
		</tr>
		<tr>
			<td><b><font face="Verdana" size="2">Replace {{EMAIL_ADDR}} with:</font></b></td>
			<td width="320">
											<input maxLength="50" size="36" name="remail" value="$remail"></td>
		</tr>
		<tr>
			<td><b><font face="Verdana" size="2">Replace {{CID}} with:</font></b></td>
			<td width="320">
											<input maxLength="50" size="36" name="rcid" value="$rcid"></td>
		</tr>
		<tr>
			<td><b><font face="Verdana" size="2">Replace {{EMAIL_USER_ID}} with:</font></b></td>
			<td width="320">
											<input maxLength="50" size="36" name="remailid" value="$remailid"></td>
		</tr>
        <tr>
            <td><b><font face="Verdana" size="2">Replace {{CAPTURE_DATE}} with:</font></b></td>
            <td width="320">
            <input maxLength="50" size="36" name="rcdate" value="$rcdate"></td>
        </tr>
        <tr>
            <td><b><font face="Verdana" size="2">Replace {{IP}} with:</font></b>
</td>
            <td width="320">
           <input maxLength="50" size="36" name="rip" value="$rip"></td>
        </tr>
		<tr>
...
print<<"end_of_html";
		...
		<tr>
			...
			<td width="290">
											<input maxLength="50" size="40" name="ip_addr" value="$mailer_ftp"></td>
		</tr>
				<tr>
...
<tr>
			<td><b><font face="Verdana" size="2">Source available upon request:</font></b></td>
			<td width="290">
											<font size="1">
											<select name="source_seq">
end_of_html
my $i=0;
while ($i <= 20)
{
...
<tr>
			<td><b><font face="Verdana" size="2">{{NETWORK_NAME}}:</font></b></td>
			<td width="290">
											<font size="1">
											<select name="network_seq">
end_of_html
my $i=0;
while ($i <= 20)
{
...
<tr>
			<td><b><font face="Verdana" size="2">Source :</font></b></td>
			<td width="290">
											<font size="1">
											<select name="source_val_seq">
end_of_html
my $i=0;
while ($i <= 20)
{
...
print<<"end_of_html";
	...
	<tr>
			<td><b><font face="Verdana" size="2">HitPath Id:</font></b></td>
			<td width="290"><input maxLength="20" size="21" name="hitpath_id" value="$hitpath_id"></td>
		</tr>
	</table>
	<p align="left">
