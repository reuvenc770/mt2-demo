...
# *****************************************************************************************
# camp_draft_preview.cgi
#
# this page presents the user with a preview of the draft campaign email
#
# History
# *****************************************************************************************
...
$sql = "select advertiser_id,html_code from draft_creative where creative_id = $campaign_id";
$sth = $dbhq->prepare($sql);
$sth->execute();
($aid,$template_text) = $sth->fetchrow_array();
$sth->finish();
$subject = "Subject goes here"; 
$from_addr="info\@zetainteractive.com";
#
...
my  $the_email = util_mail::mail_draft_preview($dbhu,$campaign_id,$format,$email_addr,$email_user_id,$user_id,$footer_color,$aid,$internal_flag,$unsub_url,$unsub_image,$content_id,$subname,$cdeploy);
...
<!--    <tr>
    ...
    <td width="468">
        ...
        <tr>
        <td align="left"><b><font face="Arial" size="2">Campaign Draft Preview</FONT></b></td>
        </tr>
        <tr>
        <td align="right">
...
<TD vAlign=top align=left bgColor=#999999>
    ...
    <TD vAlign=top align=left bgColor=#ffffff colSpan=10>
		...
		<input type="hidden" name="cdraft" value="Y">
