...
# newsletter_del.cgi
#
# this page confirms deletion of a newsletter
#
# History
# *****************************************************************************************
...
<TD vAlign=top align=left bgColor=#999999>
    ...
    <TD vAlign=top align=left bgColor=#ffffff>
        ...
        <TD><FONT face="verdana,arial,helvetica,sans serif" color=#509C10 
            size=2>You have chosen to remove the following newsletter. Are you sure you want to do this?<BR></FONT></TD>
		</TR>
        <TR>
		...
		<FORM action=nl_del_save.cgi method=post>
    		...
    		<TD align=middle>
                ...
                <TD align=middle height=15>
                    ...
                    <TD align=middle width="100%" height=15><FONT 
                        ...
                        color=white size=2><B>Delete Newsletter</B> 
                        </FONT></TD>
					</TR>
					</TBODY>
					</TABLE>
                ...
                <TD align=middle>
                    ...
                    <TD vAlign=center align=left><font face="verdana,arial,helvetica,sans serif" 
						size="2" color="#FF0000"><b>$nl_name</b></font></TD>
					</TR>
                    <TR>
		...
		<TD>
			...
			<TD width="50%" align="center">
				<a href="nl_list.cgi"><img src="$images/no.gif" border=0></a></td>
			<td width="50%" align="center">
