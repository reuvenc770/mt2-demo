...
/usr/bin/perl new_preprocess_send_email.pl 2 >> /var/www/util/logs/peaks_preprocess_send_email_$b.log
rm /tmp/fa_peaks.a
#ls /var/www/util/tmpmailfiles/list_fa_* > /tmp/fa_peaks.a
#if (-z "/tmp/fa_peaks.a") then
#	echo "No Files"
#else
