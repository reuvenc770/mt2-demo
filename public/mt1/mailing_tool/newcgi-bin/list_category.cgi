...
$sql = "select category_info.category_id,category_name,domain_name from category_info,client_category_info where category_info.category_id=client_category_info.category_id and user_id = $userid and category_info.status='A' order by category_name"; 
$sth = $dbhq->prepare($sql);
$sth->execute();
