#!/usr/bin/perl
#===============================================================================
# Purpose: Builds frames for expertsender/yesmail creative 
...
<frameset rows="*,0" border=1 width=0 frameborder=no framespacing=0>
  <frame src="/cgi-bin/expertsender_top.cgi?esp=$esp" name="main" marginwidth=0 marginheight=0 scrolling=auto>
