...
my $sth1;
my ($content_id,$content_name,$content_date,$inactive_date,$modified_date,$content_html);
...
end_of_html
	...
	$sql = "select content_id,content_name,content_date,modified_date,inactive_date,content_html from footer_content"; 
	$sth = $dbhq->prepare($sql) ;
	$sth->execute();
	$reccnt = 0 ;
	while (($content_id,$content_name,$content_date,$modified_date,$inactive_date,$content_html) = $sth->fetchrow_array())
	{
        ...
        print qq{	<TD align=left><font color="#509C10" face="Arial" size="2">$modified_date</font></TD> \n } ;
