...
function update_name()
{
    ...
    var selIndex = selObj.selectedIndex;
	var mname=selObj.options[selIndex].text;
end_of_html
if ($old_id == 0)
{
print<<"end_of_html";
	...
	{
		campform.campaign_name.value = "(" + mname + ")";
	}
	else
	{
        ...
        campform.campaign_name.value = argname + " (" + mname + ")";
print<<"end_of_html";
	}		
end_of_html
}
										...
										<tr bgColor="#e3fad1">
											...
											<table cellSpacing="0" cellPadding="0" width="100%" border="0" id="table12">
												...
												<tr>
													...
													<td><select name="two" onChange="update_name();">
end_of_html
