...
sub disp_body
{
	...
	<TR bgColor="#509C10" height=15>
		...
		<b>List of Trace Headers</font>
		<font face="Verdana,Arial,Helvetica,sans-serif" color="white" size="2">
		(click header to edit the header)</b></font></TD>
	</TR>
	<TR> 
...
end_of_html
	...
	#===========================================================================
	$sql = "select header_id,header_name,dateAdded from TraceHeaders where $userDataRestrictionWhereClause status='A' order by header_id";
