...
sub disp_body
{
	...
	<TR bgColor="#509C10" height=15>
		...
		<b>List of Template Types</font>
		<font face="Verdana,Arial,Helvetica,sans-serif" color="white" size="2">
		(click label to edit the template type)</b></font></TD>
	</TR>
	<TR> 
<TD bgcolor="#EBFAD1" align="middle" width="05%">ID</td>
	<TD bgcolor="#EBFAD1" align="left" width="10%">
		...
		<b>Label</b></font></td>
	<TD bgcolor="#EBFAD1" align="left" width="25%"><FONT face="verdana,arial,helvetica,sans serif" color="#509C10" size=2><b>Name</b></font></td>
	<TD bgcolor="#EBFAD1" align="left" width="25%"><FONT face="verdana,arial,helvetica,sans serif" color="#509C10" size=2><b>Description</b></font></td>
	<TD bgcolor="#EBFAD1" align="left" width="10%">
		<FONT face="verdana,arial,helvetica,sans serif" color="#509C10" size=2>
		<b>&nbsp;</b></font></td>
	</TR> 
...
end_of_html
	...
	#===========================================================================
	$sql = "select mailingTemplateTypeID,mailingTemplateTypeLabel,mailingTemplateTypeName,description from MailingTemplateType order by mailingTemplateTypeID";
	$sth = $dbhq->prepare($sql) ;
	$sth->execute();
	$reccnt = 0 ;
	while (($nl_id,$label,$nl_name,$desc) = $sth->fetchrow_array())
	{
		$reccnt++;
		if ( ($reccnt % 2) == 0 ) 
		{
		...
		print qq{<TD bgcolor="#EBFAD1" align="middle" width="05%">$nl_id</td>\n};
        print qq{	<TD align=left><font color="#509C10" face="Arial" size="2"> \n } ;
		print qq{		<A HREF="template_disp.cgi?pmode=U&nl_id=$nl_id">$label</a></font></TD> \n } ;
		print qq{		<td>$nl_name</font></TD> \n } ;
		print qq{		<td>$desc</font></TD> \n } ;
