#!/usr/bin/perl
#===============================================================================
# Purpose: Allows editing of ActionString 
# File   : action_edit.cgi
#
#===============================================================================
...
sub disp_body
{
	...
	$sql="select action_string from ActionString where action_id=$sid";
	$sth=$dbhu->prepare($sql);
	$sth->execute();
	($action_string)=$sth->fetchrow_array();
	$sth->finish();

	print << "end_of_html" ;
	<center><form method=post action="/cgi-bin/action_upd.cgi"><input type=hidden name=sid value=$sid>Action String: <input type=text name="action_string" size=80 maxlength=255 value="$action_string">&nbsp;&nbsp;<input type=image src="/mail-images/save.gif" border=0></form><br><br>
	<table>
