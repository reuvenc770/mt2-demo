...
<br>
<form method=post action="/cgi-bin/view_advertiser_save.cgi" target=_blank>
...
end_of_html
	...
	print "</select></td></tr>";
print<<"end_of_html";
<tr><td align=right>Creatives To User</td><td><select name=ctype><option value="">ALL</option>
<option value="A" selected>Active</option><option value="I">Inactive</option></select></td></tr>
<tr><td align=right>Creative name:</td><td><input type=text name=cname size=30></td></tr>
<tr><td align=right>Creative IDs</td><td><textarea name=cids rows=20 cols=15></textarea></td></tr>
