#!/usr/bin/perl
#===============================================================================
# File   : upload_orange_attribution.cgi 
#
#--Change Control---------------------------------------------------------------
#===============================================================================
...
<body>
<center><h3>You do not have permission to set Record Processing Attribution.  This attempt has been logged.</h3><br>
...
sub process_file 
{
	...
	while (<SAVED>) 
	{
		...
		$sql="update user set AttributeLevel=$attr_id where user_id=$client_id and OrangeClient='Y'";
		$rows=$dbhu->do($sql);
	} 
	close SAVED;
	close LOG;
