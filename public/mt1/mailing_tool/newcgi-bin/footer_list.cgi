#!/usr/bin/perl
#===============================================================================
# Purpose: Displays a List of Footer Variations 
# File   : footer_list.cgi
#
#===============================================================================
...
sub disp_body
{
	...
	print << "end_of_html" ;
	<center><a href="/cgi-bin/footer_add.cgi"><img src="/mail-images/add.gif" border=0></a><br><br>
	<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
	<TBODY>
	<TR bgColor="#509C10" height=15>
		<TD colspan="5" align=center height=15>
		<font face="Verdana,Arial,Helvetica,sans-serif" color="white" size="3">
		<b>List of Current Footer Variations</font>
	...
	<TD bgcolor="#EBFAD1" align="left" width="10%">
		...
		<b>Name</b></font></td>
	<TD bgcolor="#EBFAD1" align="left" width=40%><FONT face="verdana,arial,helvetica,sans serif" color="#509C10" size=2><b>Unsub</b></font></td>
...
end_of_html
	...
	$sql = "select variation_id,name,privacy_text,unsub_text from footer_variation where status='A'"; 
	$sth = $dbhq->prepare($sql) ;
	$sth->execute();
	$reccnt = 0 ;
	while (($vid,$name,$privacy_text,$unsub_text ) = $sth->fetchrow_array())
	{
		$reccnt++;
		if ( ($reccnt % 2) == 0 ) 
		{
		...
		print qq{		<A HREF="footer_edit.cgi?vid=$vid">$name</a></font></TD> \n } ;
        print qq{	<TD align=left><font color="#509C10" face="Arial" size="2">$unsub_text</font></TD> \n } ;
        print qq{	<TD align=left><font color="#509C10" face="Arial" size="2">$privacy_text</font></TD> \n } ;
        print qq{	<TD align=left><font color="#509C10" face="Arial" size="2"><a href="/cgi-bin/footer_del.cgi?vid=$vid">Delete</a></font>&nbsp;\n } ;
        print qq{	<font color="#509C10" face="Arial" size="2"><a href="/variation_preview.php?vid=$vid" target=_blank>Preview</a></font></TD> \n } ;
		print qq{</TR> \n} ;
