...
my $template_name = $dbhq->quote($query->param('template_name'));
my $html_template = $dbhq->quote($query->param('html_template'));
my $text_template = $dbhq->quote($query->param('text_template'));
my $aol_template = $dbhq->quote($query->param('aol_template'));
...
my $image_url = $dbhq->quote($query->param('image_url'));
my $title = $dbhq->quote($query->param('title'));
my $subtitle = $dbhq->quote($query->param('subtitle'));
my $date_str = $dbhq->quote($query->param('date_str'));
my $greeting = $dbhq->quote($query->param('greeting'));
my $introduction = $dbhq->quote($query->param('introduction'));
my $closing = $dbhq->quote($query->param('closing'));
#my $promotion_name = $dbhq->quote($query->param('promotion_name'));
#my $promotion_desc = $dbhq->quote($query->param('promotion_desc'));
#my $promotion_image_url = $dbhq->quote($query->param('promotion_image_url'));
#my $promotion_link_name = $dbhq->quote($query->param('promotion_link_name'));
my $promotion_name = "''";
my $promotion_desc = "''";
