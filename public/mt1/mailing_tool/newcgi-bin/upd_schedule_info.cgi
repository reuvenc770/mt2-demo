...
my ($camp_cnt,$aol_cnt,$daily_cnt,$rotate_cnt,$third_cnt,$chunk_cnt);
my $max_id;
...
$sth->execute();
if (($camp_cnt,$aol_cnt,$daily_cnt,$rotate_cnt,$third_cnt,$chunk_cnt) = $sth->fetchrow_array())
{
}
else
{
...
$sth->finish();
print "parent.main.set_lists($camp_cnt,$aol_cnt,$daily_cnt,$rotate_cnt,$third_cnt,$chunk_cnt);\n";
print "</script>\n";
print "</body>\n";
print "</html>\n";
#
