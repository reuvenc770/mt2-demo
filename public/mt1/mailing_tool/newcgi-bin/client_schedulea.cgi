...
function chkcount()
{
	if (document.campform.third_cnt.value == 0)
	{
        if (confirm("Are you sure you want to submit with zero 3rd Party slots?"))
        {
			return true;
		}
		else
...
function set_lists(camp_cnt,aol_cnt,daily_cnt,rotate_cnt,third_cnt,chunk_cnt)
{
    ...
    var selObj = document.getElementById('chunk_cnt');
	selObj.selectedIndex = chunk_cnt;
}
</script>
</head>

<body><br><b><font face="Verdana">Schedule Details</font></b><font face="Verdana"><b>:</b></font><br>
<!--<b><font color=red size="+2">DO NOT use Firefox to access this page. Please use Internet Explorer ONLY</font></b><br> -->
<form name=campform method=post action="/cgi-bin/upd_client_schedule.cgi" target="bottom" onSubmit="return chkcount();">
<table border="1" width="35%" id="table24">
	<tr>
		...
		<td>
											...
											<select name="client_id" id="client_id" onChange="update_client();">
...
print<<"end_of_html";
	...
	<tr>
		...
		<td>
									<font size="1">
													<select id="camp_cnt" name="camp_cnt">
...
print<<"end_of_html";
	...
	<tr>
		...
		<td>
									<font size="1">
													<select id="third_cnt" name="third_cnt">
					<option value="0" selected>0</option>
end_of_html
my $i=1;
while ($i <= $MAX_CAMPS)
...
print<<"end_of_html";
	...
	<tr>
		...
		<td>
									<font size="1">
													<select id="aol_cnt" name="aol_cnt">
					<option value="0" selected>0</option>
end_of_html
my $i=1;
while ($i <= $MAX_CAMPS)
...
print<<"end_of_html";
	...
	<tr>
		<td>
									<b><font face="Verdana" size="2">Chunking:</font></b></td>
		<td>
									<font size="1">
													<select id="chunk_cnt" name="chunk_cnt">
					<option value="0" selected>0</option>
end_of_html
my $i=1;
while ($i <= $MAX_CAMPS)
...
print<<"end_of_html";
	...
	<tr>
		...
		<td>
									<font size="1">
													<select id="daily_cnt" name="daily_cnt">
					<option value="0" selected>0</option>
end_of_html
my $i=1;
while ($i <= $MAX_CAMPS)
...
print<<"end_of_html";
	...
	<tr>
		...
		<td>
									<font size="1">
													<select id="rotating_cnt" name="rotating_cnt">
					<option value="0" selected>0</option>
end_of_html
my $i=1;
while ($i <= $MAX_CAMPS)
