...
my $appendClient=$query->param('appendClient');
if ($appendClient eq "")
{
	$appendClient="N";
}
...
$sql="insert into AppendEID(fileName,output_fileName,status,lastUpdated,appendClient) values('$pname','$outname','In Queue',curdate(),'$appendClient')";
my $rows=$dbhu->do($sql);
print "Location: appendEID_list.cgi\n\n";
