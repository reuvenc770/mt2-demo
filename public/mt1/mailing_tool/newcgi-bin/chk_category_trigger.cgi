...
open(LOG,">/tmp/chk.log");
	...
	$sql = "select company,trigger1,trigger2,alt_trigger from category_trigger,user where category_id=$cid and user.user_id=category_trigger.client_id and client_id != 0 and category_trigger.trigger_type='$trigger_type'";
	print LOG "<$sql>\n";
