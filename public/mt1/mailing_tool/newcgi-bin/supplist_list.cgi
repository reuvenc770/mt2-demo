...
sub disp_header
{
	...
	util::header("List of Suppression Lists");    # Print HTML Header
	#-----------------------------------------------------------
	#  BEGIN HEADER FIX 
	#-----------------------------------------------------------
	print << "end_of_html";
...
sub disp_body
{
	...
	<TBODY>
	<TR>
<td colspan=3 align=center><a href="mainmenu.cgi"><img src="/mail-images/home_blkline.gif" border=0></a></td>
<td colspan=3 align=center><a href="supplist_add.cgi"><img src="/mail-images/add.gif" border=0></a></td></tr>
	<tr><td>&nbsp;</td></tr>
	<TR bgColor="#509C10" height=15>
		<TD colspan="4" align=center width="45%" height=15>
		<font face="Verdana,Arial,Helvetica,sans-serif" color="white" size="3">
		<b>List of Current Suppression Lists</font><br>
		<font face="Verdana,Arial,Helvetica,sans-serif" color="white" size="2">
		(click name to add names to a list)</b></font></TD>
	</TR>
	<TR> 
...
end_of_html
	...
	$sql = "select list_id,list_name,list_cnt,last_updated from vendor_supp_list_info order by list_name"; 
	$sth = $dbhq->prepare($sql) ;
	$sth->execute();
	$reccnt = 0 ;
	while (($puserid,$name,$cnt,$ldate) = $sth->fetchrow_array())
	{
		$reccnt++;
		if ( ($reccnt % 2) == 0 ) 
		{
		...
		{
        	print qq{	<TD align=left><font color="#509C10" face="Arial" size="2"> \n } ;
			print qq{		<A HREF="supplist_addnames.cgi?tid=$puserid">$name</a></font></TD> \n } ;
		}
		else
		{
        	print qq{	<TD align=left><font color="#509C10" face="Arial" size="2"> \n } ;
