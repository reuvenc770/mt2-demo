#!/usr/bin/perl
#===============================================================================
# Purpose: Add vendor domain suppression list (eg 'user' table).
# Name   : domain_supplist_add.cgi 
#
#--Change Control---------------------------------------------------------------
...
util::header("Add a New Domain Suppression List");
...
<TD vAlign=top align=left bgColor=#FFFFFF>
    ...
    <TD vAlign=top align=left bgColor=#ffffff colSpan=10>
        ...
        <TD vAlign=center align=left><FONT face="verdana,arial,helvetica,sans serif" color=#509C10 
            size=3><B>Suppression List</B> </FONT></TD>
		</TR>
        <TR>
...
end_of_html
	...
	print qq{ To ADD domain suppression list please enter the name \n } ;
...
print <<"end_of_html";
        ...
        <FORM name=add_list action="domain_supplist_upd.cgi" method=get onsubmit="return ProcessForm('A');">
            ...
            <TD align=middle>
                ...
                <TD align=middle height=15>
                    ...
                    <TD align=middle width="100%" height=15><FONT 
						...
						<B>Domain Suppression List</B></FONT></TD>
					</TR>
					</TBODY>
					</TABLE>
				</TD>
