...
print << "end_of_html";
					...
					Email Addr: <input type=text maxlength=255 size=80 name=cemail value="mdimaio\@zetainteractive.com,eneuner\@zetainteractive.com,david\@zetainteractive.com"><br>
