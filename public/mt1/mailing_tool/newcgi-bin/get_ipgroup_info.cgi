...
util::header("Get IPs for IP Groups");
...
<TD vAlign=top align=left bgColor=#FFFFFF>
    ...
    function check_mandatory_fields()
    {
        ...
        {
            alert("You MUST enter a value for the IP Group Name field."); 
    ...
    <TD vAlign=top align=left bgColor=#ffffff colSpan=10>
        ...
        <TD vAlign=center align=left><FONT face="verdana,arial,helvetica,sans serif" color=#509C10 
            size=3><B>Get IPs in IP Groups</B> </FONT></TD>
		</TR>
        <TR>
...
end_of_html
	...
	print qq{ Get IPs in each IP Group Specified\n}; 
print << "end_of_html" ;
			</FONT></TD>
		</TR>
		</TBODY>
        ...
        <TD>
            ...
            <TD align=middle>
                ...
                <TD align=middle>
        		<FORM name=add_list action="bulk_ipgroup_show_info.cgi" method=post onsubmit="return ProcessForm('A');">
