...
# 10/03/07  Jim Sobeck  Added Commission Wizard Fields
#===============================================================================
...
<input type="checkbox" name="copywriter" size="40" maxlength="90" value="Y">
<br>
<b>Copywriter Name</b>
<select name=copywriter_name>
end_of_html
...
<b>Commission Wizard CWC3:</b><input maxLength="10" value="" size="11" name="comm_wizard_c3"><br><br>
<b>Commission Wizard CWCID:</b><input maxLength="10" value="" size="11" name="comm_wizard_cid"><br><br>
<b>Commission Wizard CWprogID:</b><input maxLength="10" value="" size="11" name="comm_wizard_progid"><br><br>
<b>Creative CR:</b><input maxLength="10" value="" size="11" name="cr"><br><br>
<b>Landing Page L:</b><input maxLength="2" value="" size="3" name="landing_page"><br><br>
<b>Do not automatically replace href's with {{URL}}</b><input type=checkbox name="replace_flag" value="N"><br><br>
<u><b>HTML Code:</b></u>&nbsp;&nbsp;Host Images: <input type=checkbox checked name=host_images value="Y"><br>
