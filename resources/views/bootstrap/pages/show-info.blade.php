...
<div layout="column" ng-controller="ShowinfoController as info">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="form-group col-sm-4">
                    <input class="btn btn-primary btn-block" ng-disabled="info.isLoading" type="button" ng-click="info.loadData()" value="Search">
                </div>
            </div>
        </div>
    </div>
        ...
        <table md-table>
            ...
            <tbody md-body>
                <tr md-row ng-repeat="record in info.records">
                    ...
                    <td md-cell ng-bind="record.address"></td>
    ...
    <br/>
    <div class="panel panel-primary" ng-if="info.records.length > 0">
        <div class="panel-body">
            ...
            <div class="row">
                <div class="form-group col-sm-4">
                    <input class="btn btn-primary btn-block" ng-disabled="info.isSuppressing" type="button" ng-click="info.suppressRecord()" value="Suppress Record">
                </div>
            </div>
        </div>
    </div>
