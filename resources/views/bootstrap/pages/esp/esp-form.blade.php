...
<div class="form-group" ng-class="{ 'has-error' : esp.formErrors.email_id_field }">
    <label class="col-sm-2 control-label">Email ID Field</label>
    <div class="col-sm-10">
    <div class="input-group">
        ...
        <span class="input-group-addon" id="basic-addon2"><label class="no-margin" style="font-weight: normal;"><input ng-model="esp.currentAccount.email_id_field_toggle" type="checkbox"> Not Used</label></span>
    </div>
...
<div class="form-group" ng-class="{ 'has-error' : esp.formErrors.email_address_field }">
    <label class="col-sm-2 control-label">Email Address Field</label>
    <div class="col-sm-10">
    <div class="input-group">
    ...
    <span class="input-group-addon" id="basic-addon2"> <label class="no-margin" style="font-weight: normal;"><input ng-model="esp.currentAccount.email_address_field_toggle" type="checkbox"> Not Used</label></span>
        </div>
