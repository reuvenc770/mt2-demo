...
@section( 'page-menu' )
    @if (Sentinel::hasAccess('domain.add'))
        <li><a ng-click="domain.viewAdd()" aria-label="Add Domain">Add Domain</a></li>
    @endif
@stop

@section( 'content' )
    <md-card ng-init="domain.loadAccounts()">
        <md-table-container>
        ...
        <md-content class="md-mt2-zeta-theme md-hue-2">
            <md-table-pagination md-limit="domain.paginationCount" md-limit-options="[10, 25, 50, 100]"
                                 md-page="domain.currentPage" md-total="@{{domain.accountTotal}}"
                                 md-on-paginate="domain.loadAccounts" md-page-select></md-table-pagination>
        </md-content>
    </md-card>
@stop
