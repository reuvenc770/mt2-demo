<md-table-container>
    <table class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <th ng-show="domain.rowBeingEdited != 0"></th>
            <th ng-show="domain.rowBeingEdited != 0"></th>
            <th ng-show="domain.rowBeingEdited != 0"></th>
        </tr>
        </thead>
        <tbody>
        <tr  ng-repeat="record in domain.domains track by $index">
            <!--Normal View -->
            ...
            <td ng-hide="domain.beingEdited(record.dom_id)" >@{{ record.created_at }}</td>
            <td ng-hide="domain.beingEdited(record.dom_id)" >@{{ record.expires_at }}</td>
            <td ng-hide="domain.beingEdited(record.dom_id)">@{{ record.dba_name }}</td>
            <!--End Normal View -->
