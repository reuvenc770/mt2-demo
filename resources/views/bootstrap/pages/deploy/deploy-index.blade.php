...
<div ng-init="deploy.loadAccounts()">
    <div layout="row" layout-align="left left" ng-init="app.setToStaticWidth()">
    ...
    <div class="panel panel-primary" ng-style="deploy.tableWrapperStyle">
        <div class="panel-heading">
            <h3 class="panel-title">Deploys</h3>
        </div>
        <div class="panel-body">
