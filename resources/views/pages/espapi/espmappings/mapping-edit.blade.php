...
@section( 'title' , 'Edit ESP Mapping' )
...
@section( 'content' )
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default" ng-controller="espMappingController as mapping" ng-init="mapping.loadEsp()">
                <div class="panel-heading">
                    <h1 class="panel-title">Edit ESP Mapping for:: @{{esp.currentEsp.name}}</h1>
                </div>
