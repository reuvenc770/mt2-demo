...
@section( 'content' )
<div class="row">
    <div class="page-header col-xs-12"><h1 class="text-center">Add ESP Account</h1></div>
</div>
        ...
        <div class="col-xs-12 col-md-8">
            <form class="form-horizontal">
                <div class="form-group" ng-class="{ 'has-error' : esp.formErrors.espId }">
                    ...
                    <div class="col-sm-10">
                        <select id="espId" class="form-control" required="required" ng-model="esp.currentAccount.espId">
                ...
                <div class="form-group" ng-class="{ 'has-error' : esp.formErrors.accountName }">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="accountName" class="form-control" required="required" ng-model="esp.currentAccount.accountName" value="" />
                ...
                <div class="form-group" ng-class="{ 'has-error' : esp.formErrors.key1 }">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="key1" class="form-control" required="required" ng-model="esp.currentAccount.key1" value="" />
                ...
                <div class="form-group" ng-class="{ 'has-error' : esp.formErrors.key2 }">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="key2" class="form-control" ng-model="esp.currentAccount.key2" value="" />
