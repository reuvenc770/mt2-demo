                ...
                <md-table-container>
                    <table md-table class="mt2-table-large" md-progress="deploy.queryPromise">
                        ...
                        <tr md-row ng-repeat="record in deploy.deploys track by $index"
                            ng-class="{ 'mt2-bg-warn' : record.deployment_status == 0, 'mt2-bg-success' : record.deployment_status ==1, 'mt2-bg-danger' : record.deployment_status == 2 }">
                            <td md-cell>
                            ...
                            <td md-cell>
                                <div layout="row" layout-align="center center">
                                    <md-button class="md-raised md-icon-button mt2-icon-button-xs" ng-click="deploy.editRow( record.deploy_id)">
                                        <md-icon md-svg-icon="img/icons/ic_mode_edit_black_18px.svg"></md-icon>
                                    </md-button>
                                    <md-button class="md-raised md-accent md-icon-button mt2-icon-button-xs" ng-click="deploy.copyRow( record.deploy_id)">
