        ...
        <div class="panel panel-primary">
            ...
            <div ng-show="dba.currentAccount.po_boxes.length > 0" class="panel-footer">
                <p ng-repeat="(key, value) in dba.currentAccount.po_boxes track by $index"> @{{value.address}} @{{value.address_2}} @{{value.city}} @{{value.state}} @{{value.zip}} <a ng-click="dba.editPOBox(key)">Edit</a> <a ng-click="dba.removePOBox(key)">Remove</a> </p>
            </div>
        </div>