    ...
    <table md-table md-progress="attr.queryPromise">
        <thead md-head md-order="attr.query.order" md-on-reorder="attr.getRecords">
            <tr md-row>
                ...
                <th md-column md-order-by="email_id" md-numeric class="md-table-header-override-whitetext">EID</th>
                <th md-column md-order-by="deploy_id" md-numeric class="md-table-header-override-whitetext">Deploy</th>
        ...
        <tbody md-body>
            <tr md-row ng-repeat="record in { true : attr.records , false : [] }[ attr.query.type === 'Record' ]">
