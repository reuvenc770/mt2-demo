mt2App.controller( 'ClientGroupController' , [ '$rootScope' , '$log' , '$window' , '$location' , 'ClientGroupApiService' , 'FeedApiService' , '$mdToast' , 'formValidationService' , 'modalService' , 'orderByFilter' , function ( $rootScope , $log , $window , $location , ClientGroupApiService , FeedApiService , $mdToast , formValidationService , modalService , orderBy ) {
    /**
     * Contants
     */
    var self = this;
    ...
    self.clientNameField = "displayName";
    ...
    self.getAllFeedsSuccessCallback = function ( response ) {
        var tempClientList = response.data;

        angular.forEach( tempClientList , function( feedGroup ) {
            feedGroup.displayName = feedGroup.client_id + ' - ' + feedGroup.username ;
        } );

        self.clientList = orderBy( tempClientList , 'username' );
    };
    ...
    self.prepopPageDataFailureCallback = function ( response ) {
        modalService.setModalLabel( 'Error' );
        modalService.setModalBody( 'Failed to load Feed Group details.' );
    ...
    self.prepopPageClientsFailureCallback = function ( response ) {
        modalService.setModalLabel( 'Error' );
        modalService.setModalBody( 'Failed to load Feed Group\'s clients.' );
    ...
    self.copyClientGroupFailureCallback = function ( response ) {
        ...
        modalService.setModalLabel( 'Error' );
        modalService.setModalBody( 'Failed to copy feed group.' );
    ...
    self.deleteClientGroupFailureCallback = function ( response ) {
        ...
        modalService.setModalLabel( 'Error' );
        modalService.setModalBody( 'Failed to delete feed group.' );
