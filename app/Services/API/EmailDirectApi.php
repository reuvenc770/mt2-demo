    ...
    private function getReportStats () {
        ...
        foreach ( $this->campaignList as $currentCampaign ) {
            ...
            if ( $campaignDetailsResponse->success() ) {
                ...
                throw new \Exception( 'Email Direct API Call Failed.' . $campaignDetailsResponse->getErrorMessage(). ' '. json_encode( $campaignDetailsResponse->getRequestInfo() ) , $campaignDetailsResponse->getErrorCode() );
            }
        }
