...
class BrontoRawReports extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('reporting_data')->create('bronto_reports', function (Blueprint $table) {
            ...
            $table->float('delivery_rate')->unsigned()->default(0);
            $table->float('open_rate')->unsigned()->default(0);
            $table->float('click_rate')->unsigned()->default(0);
            $table->float('click_through_rate')->unsigned()->default(0);
            $table->float('conversion_rate')->unsigned()->default(0);
            $table->float('bounce_rate')->unsigned()->default(0);
            $table->float('complaint_rate')->unsigned()->default(0);
            $table->float('contact_loss_rate')->unsigned()->default(0);
