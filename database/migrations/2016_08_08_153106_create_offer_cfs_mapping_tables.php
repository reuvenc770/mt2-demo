...
class CreateOfferCfsMappingTables extends Migration
{
     ...
     */
    public function up() {
        Schema::connection('reporting')->create('offer_creative_maps', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::connection('reporting')->create('offer_from_maps', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('offer_id')->default(0);
        ...
        Schema::connection('reporting')->create('offer_subject_maps', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('offer_id')->default(0);
        ...
        Schema::connection('reporting')->table('creatives', function($table) {
            $table->dropIndex('offer_id');
            $table->dropColumn('offer_id');
        });

        Schema::connection('reporting')->table('froms', function($table) {
            $table->dropIndex('offer_id');
            $table->dropColumn('offer_id');
        });

        Schema::connection('reporting')->table('subjects', function($table) {
            $table->dropIndex('offer_id');
            $table->dropColumn('offer_id');
        });
    }
    ...
    public function down() {
        Schema::connection('reporting')->drop('offer_creative_maps');
        Schema::connection('reporting')->drop('offer_from_maps');
        Schema::connection('reporting')->drop('offer_subject_maps');
