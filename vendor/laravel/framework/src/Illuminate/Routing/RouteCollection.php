...
class RouteCollection implements Countable, IteratorAggregate
{
    ...
    /**
     * GTD HACK:: we run the whole route collection through the prep rather then just allRoutes, this dedupes the full
     * collection.
    ...
    /**
     * **
     * GTD HACK: Needed to move out of the command for scoping reasons.
     * Prepare the route collection instance for serialization.
