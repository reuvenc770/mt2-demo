...
elixir(function(mix) {
    ...
    //old gulp tasks, will remove after making my changes
    ...
    mix.scripts( [ 'app.js' , 'mt2app/GenericTableDirective.js' , 'mt2app/EditButtonDirective.js' , 'client/ClientController.js' , 'client/ClientApiService.js' ] , 'public/js/client.js' );
