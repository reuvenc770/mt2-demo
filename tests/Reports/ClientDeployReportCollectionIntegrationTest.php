...
class ClientDeployReportCollectionIntegrationTest extends TestCase {
    ...
    public function setUp () {
        ...
        $this->generateClientDeployReportCollection();
    }

    public function generateClientDeployReportCollection () {
        $this->sut = \App::make( \App\Reports\ClientDeployReportCollection::class );
    }
